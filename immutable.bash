...
_immutable() {
    ...
    local subcommands="create shell run list list-names switch reset delete status lock unlock recovery reset-recovery clean-boot update-initramfs update-base restore-base update export import help"
